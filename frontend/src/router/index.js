...
router.beforeEach(async (to) => {
  // Local dev shortcut: skip the marketing landing page + auth gate. `/`
  // renders FlowView (the default landing experience) directly. Only active
  // when running under `vite` (import.meta.env.DEV) — production builds are
  // unaffected. Say the word to turn this off.
