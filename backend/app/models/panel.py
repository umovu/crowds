...
class AnswerRow(DataModel):
    ...
    reframed_question: str = Field(default=None, json_schema_extra={'when': 'answered'})
    agent_name: Optional[str] = Field(default=None, json_schema_extra={'when': 'answered'})
    actor_archetype: Optional[str] = Field(default=None, json_schema_extra={'when': 'answered'})
    ...
    error: str = Field(default=None, json_schema_extra={'when': 'failed'})
    failed: Literal[True] = Field(default=None, json_schema_extra={'when': 'failed'})
    library_id: str = Field(default=None, pattern='^[0-9a-f]{16}$', json_schema_extra={'when': 'optional'})
    budget_tier: BudgetTier = Field(default=None, json_schema_extra={'when': 'optional'})
...
class RoomSeat(DataModel):
    ...
    HEADER: ClassVar[Dict[str, Any]] = {'version': 1, 'room_income_provenance': ['grant_schedule']}
    ...
    stance: Optional[Stance] = Field(default=None, json_schema_extra={'when': 'optional'})
    ...
    budget_tier: Optional[BudgetTier] = Field(default=None, json_schema_extra={'when': 'optional'})
    is_grant_dependent: bool = Field(default=None, json_schema_extra={'when': 'optional'})
    grant_type: Optional[str] = Field(default=None, json_schema_extra={'when': 'optional'})
