...
SEGMENTS = {
    "everyone": {
        ...
        "kind": "who",
        "label": "Everyone",
        "description": "A mix that matches South Africa: most people live on grants or informal work, as in real life",
        "predicate": None,
    },
    "unemployed": {
        "topics": ['money'],
        "kind": "who",
        "label": "Out of work",
        "description": "Unemployed, including people who have given up looking",
        "predicate": persona_is(FACT.employment_status, "Unemployed", "Discouraged job seeker"),
    },
    "grant_recipients": {
        "topics": ['money'],
        "kind": "who",
        "label": "Living on a grant",
        "description": "Households that live mainly on a SASSA grant",
        "predicate": persona_is(FACT.actor_archetype, "grant_dependent_survivor"),
    },
    "informal_traders": {
        "topics": ['money'],
        "kind": "who",
        "label": "Street and spaza traders",
        "description": "Sell from a stall, a spaza shop or the street",
    ...
    "small_business": {
        ...
        "description": "Run a registered small business",
        "predicate": persona_is(FACT.actor_archetype, "small_business_owner"),
    },
    "youth": {
        "topics": ['money', 'education'],
        "kind": "who",
        "label": "Young people (15-34)",
        "description": "Aged 15 to 34, working or not",
    ...
    "farmers": {
        ...
        "kind": "who",
        "label": "Farmers",
        "description": "Grow food or keep livestock, for the family or to sell",
        "predicate": persona_is(FACT.actor_archetype, "communal_farmer", "smallholder_emerging_farmer"),
    },
    "smallholder_owners": {
        "topics": ['food', 'environment'],
        "kind": "who",
        "label": "Farmers who sell",
        "description": "Own a small farm, sell for income and decide what the farm spends",
    ...
    "professionals": {
        "topics": ['money'],
        "kind": "who",
        "label": "Managers and professionals",
        "description": "Office, professional and management jobs; budgets here are moderate, not rich",
    ...
    "employed": {
        ...
        "kind": "who",
        "label": "Working",
        "description": "Have a job, formal or informal",
    ...
    "learners": {
        "topics": ['education'],
        "kind": "who",
        "label": "High-school learners (15-18)",
        "description": "At school, aged 15 to 18",
        "predicate": persona_is(FACT.actor_archetype, "learner"),
    },
    "guardians": {
        "topics": ['education', 'health'],
        "kind": "who",
        "label": "Parents of school kids",
        "description": "Adults raising children who are at school",
    ...
    "gogo_guardians": {
        "topics": ['education', 'health'],
        "kind": "who",
        "label": "Grandparents raising kids",
        "description": "Grandparents raising grandchildren who are at school",
        "predicate": _is_gogo,
    ...
    "fee_paying": {
        "topics": ['education'],
        "kind": "who",
        "label": "Families paying school fees",
        "description": "Pay school fees for at least one child",
        "predicate": lambda p: _pays_school_fees(p),
    },
    "no_fee_school": {
        "topics": ['education'],
        "kind": "who",
        "label": "Families at no-fee schools",
        "description": "All their children are at no-fee schools",
    ...
    "guardians_low_fee": {
        "topics": ['education'],
        "kind": "who",
        "label": "Parents: low school fees",
        "description": "Pay up to R4,000 a year in fees; tight budgets",
    ...
    "guardians_high_fee": {
        "topics": ['education'],
        "kind": "who",
        "label": "Parents: high school fees",
        "description": "Pay over R4,000 a year in fees; room to spend",
        "predicate": lambda p: _is_guardian(p)
    ...
    "learners_low_fee": {
        ...
        "description": "Learners at schools charging up to R4,000 a year",
    ...
    "learners_high_fee": {
        ...
        "description": "Learners at schools charging over R4,000 a year",
        "predicate": lambda p: _is_learner(p) and _fee_tier(p) == "high_fee",
    },
    "guardians_no_fee": {
        "topics": ['education'],
        "kind": "who",
        "label": "Parents: no-fee schools",
        "description": "Children at no-fee schools, so no fees to pay now",
        "predicate": lambda p: _is_guardian(p)
        and _fee_tier(p) == "no_fee",
        "certainty": guardian_certainty,
    },

    # ── Groups from GHS household facts (#112) ───────────────────────────────
    # Home, car and medical aid: the facts a priced pitch most often turns on,
    # and the ones the research cards now gate on. Medical aid is compared as
    # text: people read from their own GHS row carry a bool, filled ones a string.
    "pensioners": {
        "topics": ['money', 'health'],
        "kind": "who",
        "label": "Pensioners (60+)",
        "description": "Aged 60 and over",
        "predicate": lambda p: isinstance(fact_value(p, FACT.age), int) and fact_value(p, FACT.age) >= 60,
    },
    "city_dwellers": {
        "topics": ['government', 'environment'],
        "kind": "who",
        "label": "City and town dwellers",
        "description": "Live in a city or town",
        "predicate": persona_is(FACT.geotype, "Urban"),
    },
    "rural_households": {
        "topics": ['government', 'food', 'environment'],
        "kind": "who",
        "label": "Rural households",
        "description": "Live in a village, on tribal land or on a farm",
        "predicate": persona_is(FACT.geotype, "Traditional", "Farms"),
    },
    "homeowners": {
        "topics": ['home'],
        "kind": "who",
        "label": "Homeowners",
        "description": "Their household owns its home, paid off or with a bond",
        "predicate": persona_is(FACT.housing_tenure, "own", "bond"),
    },
    "bond_holders": {
        "topics": ['home', 'money'],
        "kind": "who",
        "label": "Paying off a home loan",
        "description": "Their household is still paying off a bond",
        "predicate": persona_is(FACT.housing_tenure, "bond"),
    },
    "renters": {
        "topics": ['home'],
        "kind": "who",
        "label": "Renters",
        "description": "Their household rents where it lives",
        "predicate": persona_is(FACT.housing_tenure, "rent"),
    },
    "car_owners": {
        "topics": ['home'],
        "kind": "who",
        "label": "Own a car",
        "description": "Own a car themselves",
        "predicate": persona_is(FACT.owns_vehicle, "own"),
    },
    "no_car": {
        "topics": ['home'],
        "kind": "who",
        "label": "No car",
        "description": "No car in the household: walk, taxi or bus",
        "predicate": persona_is(FACT.owns_vehicle, "none"),
    },
    "has_medical_aid": {
        "topics": ['health'],
        "kind": "who",
        "label": "Have medical aid",
        "description": "Covered by a medical aid scheme",
        "predicate": lambda p: str(fact_value(p, FACT.medical_aid)) == "True",
    },
    "no_medical_aid": {
        "topics": ['health'],
        "kind": "who",
        "label": "No medical aid",
        "description": "Not covered by medical aid: public clinics or paying cash",
        "predicate": lambda p: str(fact_value(p, FACT.medical_aid)) == "False",
    },
    ...
    "green_already": {
        "topics": ['environment'],
        "kind": "thinks",
        "label": "Care about the environment",
        "description": "Pollution and climate are real worries in their daily life",
        "predicate": persona_is(FACT.environment_priority, "high"),
    },
    "green_blind_spot": {
        "topics": ['environment'],
        "kind": "thinks",
        "label": "Don't think about the environment",
        "description": "Not on their radar yet: the people you'd have to win over",
        "predicate": persona_is(FACT.environment_priority, "low"),
    },
    "pays_for_quality": {
        "topics": ['money'],
        "kind": "thinks",
        "label": "Pay more for better",
        "description": "Would rather pay more than take the cheap version",
    ...
    "price_first": {
        ...
        "kind": "thinks",
        "label": "Cheapest wins",
        "description": "Won't pay extra for quality: the hardest sell",
        "predicate": persona_is(FACT.pays_for_quality, "no"),
    },
    "health_trusting": {
        "topics": ['health'],
        "kind": "thinks",
        "label": "Trust health advice",
        "description": "Take official health advice seriously",
    ...
    "clinic_frustrated": {
        ...
        "description": "Unhappy with the health care they actually get",
    ...
    "service_frustrated": {
        "topics": ['government', 'environment'],
        "kind": "thinks",
        "label": "Let down by water, power or refuse",
        "description": "Unhappy with the basic services where they live",
    ...
    "pessimistic": {
        ...
        "description": "Gloomy about the economy and their own chances",
...
SEGMENT_TOPICS = [
    ...
    {"id": "home", "label": "Home & transport",
     "description": "Renting, owning, home loans, cars and getting around"},
]
...
def _frame_as_decision(text: str, probes: Optional[List[str]], operator_context: str) -> str:
    ...
    if extra:
        ...
        framed += f"\nAlso: {extra[0]}"
    # No word-of-mouth ask of our own: only the founder's words ask it
    # (mode_specs.pitch_asks_word_of_mouth).
...
def frame_pitch(pitch: str, mode: str, probes: Optional[List[str]] = None, operator_context: str = "") -> str:
    ...
    # No word-of-mouth ask of our own. Appended here it went to every pitch and every
    # answer ended on it; now it is asked only when the founder's words ask it
    # (mode_specs.pitch_asks_word_of_mouth), and the report counts it only then.
    return framed
